						...
						<tr>
							<td><label class="form-check-label"> <input
									...
									<td><a href="${R}admin/excelView/${pastReport.id}"><button
										...
										href="javascript:OnloadImg('')" BORDER="0"><button
												type="button" class="btn btn-primary btn-sm">img</button></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>

			<!--   <img src="readReportImage?reportId=27" class="img-responsive"
