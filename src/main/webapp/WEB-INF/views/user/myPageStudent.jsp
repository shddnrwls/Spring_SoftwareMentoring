...
<body id="page-top">
	...
	<div style= "float:center">
		...
		<form:form method="post" modelAttribute="user" name="myPageForm" action="myPageStudent" enctype="multipart/form-data">
			<div class="text-center">
				
				<!-- 사진 이미지 자리 	-->
                <img src="image?userId=${user.id}" class="img-responsive"  width="30%;" height="30%;" style="border-radius: 5px;">
               
				
				<input type="file" name="fileUpload" class="form-control-file" multiple> <br />
               
	             <fieldset disabled>
					<label style="float: left;">ID(학번)</label>
					<form:input path="userId" class="form-control" /><br />
				</fieldset>			
				...
				<label class="form-control-label" style="float: left;">새 비밀번호</label> 
				<input type="password" class="form-control" name="newPassword" placeholder="영문 숫자조합 10자 이상" onkeyup="verify.check()"> <br />
			
				<label class="form-control-label" style="float: left;">새 비밀번호 확인</label> 
				<input type="password" class="form-control" name="password2" placeholder="영문 숫자조합 10자 이상" onkeyup="verify.check()">
				
				<!-- <!-- 새 비밀번호 일치불일치 확인 자바스크립트  -->
				<div id="password_result" style= "float:left"> </div> <br /><br /> -->
				...
				<label class="form-control-label" style="float: left;">핸드폰 번호</label> 
				<form:input path="phoneNumber" class="form-control" /> <br />
				
				<!-- 학생인경우  -->
				
				<fieldset disabled>
					<label class="form-control-label" style="float: left;">권한</label> 
					<input class="form-control" value="${ user.authority == 1 ? "멘티" : (user.authority == 2 ? "멘토" : "관리자") }" />
				</fieldset>
<%-- 
