	...
	<div style="width: 60%; margin: auto; margin-bottom: 30px;">
		...
		<form:form method="post" modelAttribute="user" name="myPageForm"
			...
			<div class="text-center">
				...
				<fieldset disabled>
					<label style="float: left;">ID(교번)</label>
				...
				<input type="hidden" name="professor.labNumber" value="${professor.labNumber}" />
				<input type="hidden" name="professor.labPhoneNumber" value="${professor.labPhoneNumber}" /> 
