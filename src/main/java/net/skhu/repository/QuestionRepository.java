...
public interface QuestionRepository extends JpaRepository<Question, Integer> {
	...
	public default List<Question> findAll(Pagination pagination) {
	...
	public Page<Question> findByTitleContains(String title, Pageable pageable);
	public Page<Question> findByContentContains(String content, Pageable pageable);
	public Question findTopByOrderByNoDesc();
	 ...
	 */
    @Modifying
    @Query("UPDATE Question SET userId=:userId, title=:title, content=:content, date=CURRENT_TIMESTAMP() WHERE id=:id")
    public void update(@Param("id") int id, @Param("userId") int userId, @Param("title") String title, @Param("content") String content);
